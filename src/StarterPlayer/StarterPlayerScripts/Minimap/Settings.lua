...
local Settings = 
	{
		...
		["Map"] = {
			["mapId"] = 8215370389; --The textureid for the map.
			["size"] = Vector2.new(2048, 2048); --The size of the map in studs.
			["mapCenter"] = Vector3.new(0, 242, 0)
		};
		...
		["Technical"] = { --This is some technical settings.
			...
			["Visible"] = false; --This is for when you want to have your minimap hidden when the player initially joins. You will have to toggle the minimap with scripts if this is set to false.
